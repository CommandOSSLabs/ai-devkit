...
thin generated adapter, e.g. Claude Code `.claude/skills/<skill-dir>/SKILL.md`,
Grok Build `.grok/skills/<skill-dir>/SKILL.md`), **direct-discovery** (Codex reads
...
e.g. Cursor `.cursor/rules/<skill-dir>.mdc`), and **generic** (everything else
